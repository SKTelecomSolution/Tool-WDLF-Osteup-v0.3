...
:Password 
cls
set /p pass="%DEL% %COL%[37mvui lòng nhập mật khẩu để bắt đầu sử dụng tool v0.3 WDLF osteup vietsub tool hone free > "
if /i "%pass%"== "osteup" goto Disclaimer
...
echo.                   `.
echo.
echo                                        %COL%[90m HoneCtrl Là Tool Miễn Phí Cho Các Máy Tính
echo                                        %COL%[90m    được thực hiện để cải thiện năng suất hàng ngày của bạn
echo.
echo.
echo.
echo %COL%[91m  Cảnh Báo:
echo %COL%[37m  Xin lưu ý rằng chúng tôi không thể đảm bảo tăng FPS từ việc áp dụng các tối ưu hóa của chúng tôi, mọi hệ thống + cấu hình đều khác nhau.
echo.
echo     %COL%[33m1.%COL%[37m Mọi thứ đều "tự chịu rủi ro khi sử dụng", chúng tôi %COL%[91mKHÔNG CHỊU TRÁCH NHIỆM%COL%[37m nếu máy bạn gặp trường hợp xấu và rủi ro
echo        (ex. not following the disclaimers carefully).
echo.
echo     %COL%[33m2.%COL%[37m Nhưng mà cũng đừng lo lắng vì chúng tôi tạo 1 bản backup sẵn cho bạn tại system restore :33
echo.
echo     %COL%[33m3.%COL%[37m Mặc dù chúng tôi có tính năng điểm khôi phục tự động, chúng tôi thực sự khuyên bạn nên tạo điểm khôi phục thủ công trước khi chạy.
echo.
echo   Nếu có bất kỳ câu hỏi và/hoặc thắc mắc nào, vui lòng tham gia discord của chúng tôi: discord.gg/hone , discord.gg/ytB474gye2
echo.
echo   Tool Được Vietsub lại bởi Youtuber WDLF Osteup :33
echo.
echo   Làm Ơn Bấm "toi dong y" Để Được Tiếp Tục Sử Dụng Tool:
echo.
echo.
echo.
set /p "input=%DEL%                                                            >: %COL%[92m"
if /i "!input!" neq "toi dong y" goto Disclaimer
...
IF "%local%" gtr "%localtwo%" (
	...
	echo  --------------------------------------------------------------
	echo.
	echo                  Phiên Bản Tool đang dùng: %localtwo%
	echo.
	echo                    Bản Mới Chưa cập nhập: %local%
	echo                 Update Xong là ngôn ngữ tiếng anh nhé
	echo.
	echo.
	echo      [Y] Có, Update cho tôi
	echo      [N] Không
	echo.
...
echo.
echo.
echo                                           %COL%[33m[%COL%[37m 1 %COL%[33m]%COL%[37m Tối Ưu Hoá        %COL%[33m[%COL%[37m 2 %COL%[33m]%COL%[37m Game Settings
echo.
echo.
echo.
echo.
echo                                     %COL%[33m[%COL%[37m 3 %COL%[33m]%COL%[37m Media         %COL%[33m[%COL%[37m 4 %COL%[33m]%COL%[90m Bảo Mật        %COL%[33m[%COL%[37m 5 %COL%[33m]%COL%[90m Tính thẩm mỹ
echo.
echo.
echo.
echo.
echo                                               %COL%[33m[%COL%[37m 6 %COL%[33m]%COL%[37m Nâng Cao           %COL%[33m[%COL%[37m 7 %COL%[33m]%COL%[37m Thêm Chi Tiết
echo. 
echo.
echo.
echo.
echo.
echo.
echo                                                            %COL%[31m[ X để đóng ]%COL%[37m  
echo.
%SystemRoot%\System32\choice.exe /c:1234567XD /n /m "%DEL%                                        Chọn một số tương ứng với các tùy chọn trên > "
set choice=%errorlevel%
...
echo.
echo.
echo                                  %COL%[31m Tính năng này vẫn chưa hoàn thiện nhưng sẽ sớm ra mắt...
echo.
echo.
echo.
echo.
echo                                                    %COL%[97m[ Nhấn phím bất kì để quay lại ]%COL%[37m
pause >nul
goto:eof
...
echo              %COL%[90mPower Plan Máy Để Bàn, Không tốt     %COL%[90mThay Đổi Phân Chia Tối Ưu             %COL%[90mCSRSS là một sự di chuyển về đầu vào chuột
echo              %COL%[90mCho Máy Tính Laptop                  %COL%[90mHệ Thống Services Cho RAM             %COL%[90mđặt thành cao để cải thiện độ trễ đầu vào
echo.
...
echo              %COL%[90mTweaks này Giúp Refresh CPU          %COL%[90mBật MSI Mode Cho GPU                  %COL%[90mTinh chỉnh này mở khoá
echo              %COL%[90mCủa Bạn Tốt Và Mượt                  %COL%[90mvà dịch vụ mạng internet              %COL%[90mcác nhân và luồng cpu
echo.
...
echo              %COL%[90mTối Ưu độ ưu tiên cho app,           %COL%[90mTối ưu hóa fsutil của bạn, window     %COL%[90mLoại bỏ chế độ gia tốc
echo              %COL%[90mhệ thống của bạn                     %COL%[90mKhởi động nhanh và nhiều thứ khác     %COL%[90mcủa con chuột 
echo.
...
echo              %COL%[90mVô hiệu hoá bản sao bảo vệ           %COL%[90mVô hiệu hóa yêu cầu ưu tiên từ       %COL%[90mTối ưu settings NVIDIA của bạn và
echo              %COL%[90mcủa illegal High Definition content  %COL%[90mLịch trình của GPU                   %COL%[90mThêm các tweaks tối ưu mượt mà 
...
echo              %COL%[90mXoá Nvidia telemetry Không cần thiết %COL%[90mNhiều tinh chỉnh cần thiết cho       %COL%[90mDừng dữ liệu được kết hợp
echo              %COL%[90mtrên máy tính của bạn và driver      %COL%[90mCard Đồ Hoạ NVIDIA                   %COL%[90mvà lưu trữ tạm thời
echo.
echo.
echo.
echo                                     %COL%[90m[ B quay lại ]         %COL%[31m[ X đóng ]         %COL%[36m[ N qua trang tiếp ]
echo.
set /p choice="%DEL%                                        %COL%[37mChọn một số tương ứng với các tùy chọn trên > "
...
echo              %COL%[90mTắt services dư thừa và giảm bộ nhớ  %COL%[90mTweaks này sẽ lược bỏ bớt            %COL%[90mVô hiệu hóa bảo vệ chống lại bộ nhớ khỏi
echo              %COL%[91mKhông dùng nếu bạn sử dụng wi-fi     %COL%[90mapp hệ thống không cần thiết         %COL%[90mcác cuộc tấn công dựa trên tiêu thụ perf
echo.
...
echo              %COL%[90mTweaks Tối Ưu Internet               %COL%[90mTối Ưu Hoá Settings Card Internet    %COL%[90mTweaks này giúp cho tốc độ mạng 
echo              %COL%[91mKhông dùng nếu bạn sử dụng wi-fi     %COL%[91mKhông dùng nếu bạn sử dụng wi-fi     %COL%[90mmáy tính chạy mượt hơn
echo.
...
echo              %COL%[90mTinh Chỉnh Cho Tất Cả Các GPU     %COL%[90mTăng VRAM Cho GPU Intel              %COL%[90mTinh Chỉnh Card Đồ Hoạ AMD
echo              %COL%[90mIntel, AMD, NVIDIA, ...           %COL%[90mIntel iGPU được tăng Vram ảo         %COL%[90mSettings chạy tối ưu
echo.
echo                                                        %COL%[1;4;34m Các Tinh Chỉnh Khác%COL%[0m
echo.
...
echo              %COL%[90mLoại bỏ tệp tin rác, dư thừa,...     %COL%[90mSets GPU ^& CPU Hiệu suất cao   %COL%[90mChế độ thúc đẩy tốc độ phần mềm
echo              %COL%[90mdọn bộ nhớ tạm, thùng rác.           %COL%[90mVô hiệu hoá toàn màn hình tối ưu%COL%[90mnhanh chóng khi sử dụng
echo.
echo.
echo.
echo                                     %COL%[90m[ B quay lại ]         %COL%[31m[ X đóng ]         %COL%[36m[ N qua trang tiếp ]
...
echo                                                        %COL%[1;4;34mCác Tinh Chỉnh Khác%COL%[0m
echo.
echo.     %COL%[33m[%COL%[37m 10 %COL%[33m]%COL%[37m Cleaner %BLANK%                   %COL%[33m[%COL%[37m 11 %COL%[33m]%COL%[37m Game-Booster %BLANK%              %COL%[33m[%COL%[37m 12 %COL%[33m]%COL%[37m Soft Restart %BLANK%
echo              %COL%[90mLoại bỏ tệp tin rác, dư thừa,...     %COL%[90mSets GPU ^& CPU Hiệu suất cao   %COL%[90mChế độ thúc đẩy tốc độ phần mềm
echo              %COL%[90mdọn bộ nhớ tạm, thùng rác.           %COL%[90mVô hiệu hoá toàn màn hình tối ưu%COL%[90mnhanh chóng khi sử dụng
echo.
echo.
echo.                                                     	  %COL%[1;4;31mCác Tinh Chỉnh Khác%COL%[0m
echo.
echo.			 			     %COL%[33m[%COL%[37m Nhấn A để qua trang %COL%[33m]
echo.	
echo.
echo.
echo.
...
echo.
echo %COL%[91m  Cảnh Báo:
echo %COL%[91m  Tweaks này dành cho mạng có dây, nếu sử dụng wifi - mạng không dây thì bạn không nên chạy tweaks này !!! 
echo.
echo   %COL%[37mNếu có câu hỏi nào thắc mắc thì hãy tham gia discord: discord.gg/hone , discord.gg/ytB474gye2
echo.
echo   %COL%[37mNhập "toi hieu roi" Để sẵn sàng cho việc tối ưu tiếp:
echo.
echo.
echo.
set /p "input=%DEL%                                                            >: %COL%[92m"
if /i "!input!" neq "toi hieu roi" goto Tweaks 
...
:Intel
echo %DSSOF% | find "N/A" >nul && call :HoneCtrlError "Bạn không sử dụng gpu intel" && goto Tweaks
...
echo.
echo              %COL%[33m[ %COL%[37m1 %COL%[33m]%COL%[37m Cài đặt/Cập nhập OBS           %COL%[33m[ %COL%[37m2 %COL%[33m]%COL%[37m Quay màn hình                  %COL%[33m[ %COL%[37m3 %COL%[33m]%COL%[37m Streaming
echo              %COL%[90mTự động tải và cập nhập              %COL%[90mTự động Settings OBS Dựa trên        %COL%[90mTự động tối ưu settings cho livestreams
echo              %COL%[90mOBS Sử dụng link mặc định            %COL%[90mSở thích của bạn                     %COL%[90mTrên OBS một cách tốt nhất
echo.                   
echo.                                                                                             
...
echo              %COL%[90mSửa đổi tỉ lệ độ rõ nét video OBS    %COL%[90mGiảm dung lượng kích cỡ video        %COL%[90mĐiều chỉnh chất lượng clip
echo              %COL%[90mvà tăng bitrate trên YouTube         %COL%[90mBằng cách nén tệp lại                %COL%[90mCho chơi game tốt hơn
echo.
echo.
...
echo              %COL%[90mTự động tải và cập nhập              %COL%[90mCài đặt Blur tự động cho             %COL%[90mBlur settings tốt cho game
echo              %COL%[90mLiên kết chính thức của Soft Blur    %COL%[90mgame góc nhìn thứ nhất               %COL%[90mMượt mà di chuyển máy quay trơn tru
echo.
echo.
echo                                                            %COL%[34m%COL%[1mVideo Editor Settings%COL%[0m
echo.
echo              %COL%[33m[ %COL%[37m10 %COL%[33m]%COL%[37m Cài đặt A Video Editor (NLE)  %COL%[33m[ %COL%[37m11 %COL%[33m]%COL%[37m Project Settings              %COL%[33m[ %COL%[37m12 %COL%[33m]%COL%[37m Renders
echo              %COL%[90mTải ^& Cài đặt A		          %COL%[90mtự động settings Project 	       %COL%[90mTối ưu rendet settings  
echo		      %COL%[90mNon-Linear Phần mềm Edit  	  %COL%[90mcho Vegas pro                       %COL%[90mcho phần mềm Vegas pro
echo.
...
echo.                   `.
echo.
echo              %COL%[33m[ %COL%[37m1 %COL%[33m]%COL%[37m Chất Lượng                     %COL%[33m[ %COL%[37m2 %COL%[33m]%COL%[37m Tuỳ Chỉnh                        %COL%[33m[ %COL%[37m3 %COL%[33m]%COL%[37m Hiệu Năng
echo              %COL%[90mSettings Chất Lượng Cao              %COL%[90mSettings Hiệu Năng Cao               %COL%[90mSetting Tốt Nhất Cho
echo              %COL%[90mNhưng Hiệu Năng Giảm                 %COL%[90mNhưng Chất Lượng Thấp                %COL%[90mHiệu năng OBS
echo.
echo.
echo.
echo.
...
echo.
echo.
echo                                                 %COL%[90m[ B để quay lại ]         %COL%[31m[ X để thoát ]
echo.
set /p choice="%DEL%                                        %COL%[37mChọn một số tương ứng với các tùy chọn trên > "
...
echo                              %COL%[90mSetting Cho Chất lượng                                %COL%[90mSetting Cho Hiệu Năng
echo                              %COL%[90mTrên OBS                                              %COL%[90mTrên OBS
echo.
echo.                                                                                                                  
echo.                                                                                                                  
echo.
...
echo.
echo.
echo                                                 %COL%[90m[ B Để quay lại ]         %COL%[31m[ X để đóng ]
echo.
set /p choice="%DEL%                                        %COL%[37mChọn một số tương ứng với các tùy chọn trên > "
if /i "%choice%"=="1" goto Quality
...
echo                            %COL%[90mSửa đổi tỉ lệ video                                  %COL%[90mSửa đổi tỉ lệ video
echo                            %COL%[90mthành chất lượng 4K                                  %COL%[90mthành chất lượng 8K
echo. 
echo.                                                                                                                  
echo.
echo.
...
echo.
echo.
echo                                                 %COL%[90m[ B quay lại ]         %COL%[31m[ X để đóng ]
echo.
set /p choice="%DEL%                                        %COL%[37mChọn một số tương ứng với các tùy chọn trên > "
...
echo.
echo.
echo                                                 %COL%[90m[ B để thoát ]         %COL%[31m[ X để đóng ]
echo.
set /p choice="%DEL%                                        %COL%[37mChọn một số tương ứng với các tùy chọn trên > "
...
echo.                   `.
echo.
echo                       %COL%[33m[ %COL%[37m1 %COL%[33m]%COL%[37m 60 - 120 FPS                                   %COL%[33m[ %COL%[37m2 %COL%[33m]%COL%[37m 120+ FPS
echo                       %COL%[90mTự động settings blurs                                %COL%[90mTự động settings blurs
echo                       %COL%[90mcho game FPS từ 60-120fps                             %COL%[90mCho game fps có từ 120fps trở lên
echo.
echo.                                                                                                                  
echo.
echo.
...
echo         %COL%[90mTự động settings blurs                    %COL%[90mTự động settings blurs                 %COL%[90mTự động settings
echo         %COL%[90mcho quay màn hình 180 - 360 fps           %COL%[90mcho quay màn hình trên 480 FPS         %COL%[90mCho hình ảnh được render 30 FPS
echo.
echo.
echo.                                                                                                                  
echo.
...
:Any
if not exist "%SystemDrive%\Program Files (x86)\blur\" cls & echo blur cài đặt không thành công...& timeout 3 & goto HoneRenders
...
echo.                  om-                                                                   #######       #######
echo.                   `.
echo                       %COL%[90mThật không may, Hone không thể cung cấp các bản phần mềm không chính thức. nếu bạn
echo                       %COL%[90mkhông thể mua Vegas Pro, một giải pháp thay thế mà chúng tôi khuyên dùng là dùng chỉnh sửa video bản freemium
echo                       %COL%[90mđược gọi là 'DaVinci Resolve' (lưu ý: chương trình này không chứa cài đặt kết xuất)^^!
echo.
echo.
echo                           %COL%[33m[ %COL%[37m1 %COL%[33m]%COL%[37m Vegas Pro website                        %COL%[33m[ %COL%[37m2 %COL%[33m]%COL%[37m DaVinci Resolve website
echo                           %COL%[90mPhần mềm trả phí                          %COL%[90mMiễn phí nhưng không hỗ trợ renders
echo.                                                                           
echo.
echo.                                                                                                                  
echo.
...
echo.
echo.
echo                                                        %COL%[90m[ B để quay lại ]
echo.
set /p "input=%DEL%                                                            >: %COL%[92m"
if /i "!input!"=="B" goto TweaksPG3
if /i "!input!" neq "toi dong y" goto Disclaimer2
...
echo              %COL%[90mGiảm tải tác vụ chỉ định CPU         %COL%[90mPhân bổ thêm băng thông              %COL%[90mCó thể giảm bớt reduce bộ đệm, 
echo              %COL%[90mXử lí tải NIC ( nên bật )            %COL%[90mcho các ứng dụng ( mượt )            %COL%[90mnhưng có khả năng giảm tốc độ mạng ( tuỳ )
echo.
echo                           %COL%[33m[%COL%[37m 4 %COL%[33m]%COL%[37m DSCP Value %DSCOF%                      %COL%[33m[%COL%[37m 5 %COL%[33m]%COL%[37m Wi-fi Congestion Provider %CONG% 
echo                           %COL%[90mSet độ ưu tiên mạng của bạn                %COL%[91mChỉ nên BẬT, khi bạn sử dụng WI-FI
echo                           %COL%[90mđể lưu lượng truy cập tăng nhanh (nên bật) %COL%[90mThay đổi thuật toán về cách xử lý dữ liệu.
echo.
echo.
...
echo              %COL%[90mGiữ CPU ở C0 dừng lại throttling     %COL%[90mChạy card đồ hoạ của bạn ở tần số    %COL%[90mBuộc CPU hoạt động ở trạng thái
echo              %COL%[90msẽ khiến cpu nóng hơn ( nên bật )    %COL%[90mcho phép là cao nhất ( nên bật )     %COL%[90mtốc độ cao nhất ( nên bật )
echo.
echo.
...
echo              %COL%[90mCài đặt nvidia tinh chỉnh tốt nhất   %COL%[90mTweask tối ưu khởi động windows      %COL%[90mTắt USB tiết kiệm điện
echo              %COL%[90mdriver tăng fps và latency           %COL%[90mvà tối ưu dữ liệu, cài đặt (nên bật) %COL%[90mảnh hưởng tới độ trễ ( nên bật )
echo.
echo.
echo.
echo                                                 %COL%[90m[ B quay lại ]         %COL%[31m[ X để đóng ]%COL%[37m
echo.
set /p choice="%DEL%                                        %COL%[37mChọn một số tương ứng với các tùy chọn trên > "
...
echo.
echo %COL%[91m  CẢNH BÁO:
echo %COL%[91m  Tweaks này dành cho máy sử dụng WI-FI ( mạng ko dây ), nếu bạn sử dụng mạng có dây, thì đừng chạy tweaks này.
echo.
echo   %COL%[37mthắc mắc với câu hỏi nào liên hệ tại: discord.gg/hone , discord.gg/ytB474gye2
echo.
echo   %COL%[37mhãy nhập "toi da hieu" để tiếp tục tối ưu hoá:
echo.
echo.
echo.
set /p "input=%DEL%                                                            >: %COL%[92m"
if /i "!input!" neq "toi da hieu" goto Tweaks 
...
echo.
echo.
echo                                                 %COL%[90m[ B để thoát ]         %COL%[31m[ X để đóng ]%COL%[37m
echo.
%SystemRoot%\System32\choice.exe /c:1BX /n /m "%DEL%                                        Chọn một số tương ứng với các tùy chọn trên > "
set choice=%errorlevel%
...
echo.
echo.
echo                                                      %COL%[1;4;34mChọn phiên bản minecraft đang chơi%COL%[0m
echo.
echo.
echo.
echo.
...
rem echo                %COL%[90mPhù hợp máy yếu                      %COL%[90mPhù hợp máy yếu                      %COL%[90mphù hợp máy cỡ trung trở lên
rem echo                %COL%[90mĐược bật bởi mặc định.               %COL%[90mĐược bật bởi mặc định.               %COL%[90mĐược bật bởi mặc định.
echo.
echo.
echo.
echo.
...
echo.
echo.
echo                                                 %COL%[90m[ B để quay lại ]         %COL%[31m[ X để đóng ]%COL%[37m
echo.
%SystemRoot%\System32\choice.exe /c:123BX /n /m "%DEL%                                        Chọn một số tương ứng với các tùy chọn trên > "
set choice=%errorlevel%
...
echo. 
echo.
echo                                                   %COL%[37m Đã ssettings cài đặt thành công
echo.
echo.
echo.
echo.
echo                                                          %COL%[90m[ B để quay lại ]%COL%[37m
echo.
...
echo. 
echo.
echo                  %COL%[33m[ %COL%[37m1 %COL%[33m] %COL%[37mBiết Thêm ( about )                                     %COL%[33m[ %COL%[37m2 %COL%[33m] %COL%[37mDisclaimer
echo.
echo.
echo                  %COL%[33m[ %COL%[37m3 %COL%[33m] %COL%[37mSao lưu dữ liệu                                         %COL%[33m[ %COL%[37m4 %COL%[33m] %COL%[37mDiscord
echo                  %COL%[90mTạo backup registry ^& tạo một bản
echo                  %COL%[90mrestore backup đề phòng lỗi registry hay hệ thống
echo.
echo.
echo                  %COL%[33m[ %COL%[37m5 %COL%[33m] %COL%[37mNhững Người Có Cống hiến tool
echo.
echo.
echo.
echo.
...
echo                                                 %COL%[90m[ B để quay lại ]         %COL%[31m[ X để đóng ]%COL%[37m
echo.
%SystemRoot%\System32\choice.exe /c:12345BX /n /m "%DEL%                                        Chọn một số tương ứng với các tùy chọn trên >"
set choice=%errorlevel%
...
cls
echo Chi tiết thêm
echo Thuộc sở hữu của AuraSide, Inc. Bản quyền đã được xác nhận quyền sở hữu.
echo Đây là GUI dành cho Tinh chỉnh thủ công.
echo Vietsub Tool Hone Bởi WDLF Osteup. 
echo.
echo.                                                      [ nhấn X để quay lại ]
echo.
echo.
echo.
...
echo.
echo.
echo %COL%[90m                                                       Vietsub Tool HoneCtrl
echo %COL%[97m                                                       WDLF Osteup - text
echo.
echo.
echo.
echo.                                                               [ Nhấn B để quay lại ]
echo.
%SystemRoot%\System32\choice.exe /c:B /n /m "%DEL%                                                               >:"
set choice=%errorlevel%
if "%choice%"=="1" goto More
...
start http://discord.gg/ytB474gye2
goto More

:gameBooster
cls & echo Chọn file chứa game cần booost
...
for %%F in ("%file%") do Reg query "HKCU\Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers" /v "%file%" >nul 2>&1 && (
	...
	echo GPU Hiệu năng cao
	echo Disable Fullscreen Optimizations
	echo CPU High Class
) >nul 2>&1
echo.
%SystemRoot%\System32\choice.exe /c:"CQ" /n /m "%BS%               [C] Tiếp tục  [Q] Thoát" & if !errorlevel! equ 2 exit /b
goto:eof
...
echo Khởi động lại Graphics Driver [...]
Restart64.exe

::Clean Standby List
echo Dọn dẹp Standby List [...]
...
echo.
echo  --------------------------------------------------------------
echo                  Khởi động lại mềm đã hoàn tất
echo  --------------------------------------------------------------
echo.
echo.
echo                             [X] Đóng
...
echo. ^& ^
echo  -------------------------------------------------------------- ^& ^
echo                  Tinh chỉnh này không được áp dụng ^& ^
echo  -------------------------------------------------------------- ^& ^
echo. ^& ^
echo      Bạn không thể sử dụng tối ưu hóa này ^& ^
echo. ^& ^
echo      %~1 ^& ^
echo. ^& ^
echo. ^& ^
...
echo. ^& ^
echo  -------------------------------------------------------------- ^& ^
echo                  Khởi động lại để có hiệu lực ^& ^
echo  -------------------------------------------------------------- ^& ^
echo. ^& ^
echo      Để %ed% %~1 Bạn cần khởi động lại để có hiệu lực tốt nhất ^& ^
echo      bạn có ^& ^ muốn khởi động lại không
echo. ^& ^
echo. ^& ^
echo. ^& ^
echo. ^& ^
...
if !errorlevel! equ 1 ( ^
	shutdown /s /t 60 /c "Cần khởi động lại, chúng tôi sẽ làm việc đó ngay bây giờ" /f /d p:0:0 ^& ^
	timeout 5 ^& ^
	shutdown -a ^& ^
	shutdown /r /t 7 /c "Tự động khởi động lại..." /f /d p:0:0 ^
) ^& ^
exit /b
setlocal EnableDelayedExpansion
goto:eof